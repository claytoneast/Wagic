...
Card.create(name: 'Heal', type:'CardHeal', price: 10, effect: "20HP for 10G. They'd call that a bargain, back in my day.")
...
Card.create(name: 'Cluster', type:'CardCluster', price: 5, effect: "Ever see an M21 cluster bomb lay into an oil field? Me neither. But watch what it does to the board...")
