...
Card.create(name: '0Dark30', type:'CardCluster', price: 15, effect: "Ever see an M21 cluster bomb lay into an oil field? Me neither. But watch what it does to the board...")
