...
Card.create(name: 'Heal', type:'CardHeal', price: 25, effect: "20HP for 25G. They'd call that a bargain, back in my day.")
...
Card.create(name: 'Switcheroo', type:'CardSwitcheroo', price: 25, effect: "Other guy might have just the letters you want. Probably not. But try it anyway.")
