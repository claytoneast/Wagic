...
var Typo = function (dictionary, affData, wordsData, settings) {
	...
	if (dictionary) {
		...
		if (this.platform == "chrome") {
			if (!affData) affData = this._readFile("lib/typo/dictionaries/" + dictionary + "/" + dictionary + ".aff");
			if (!wordsData) wordsData = this._readFile("lib/typo/dictionaries/" + dictionary + "/" + dictionary + ".dic");
		} else {
